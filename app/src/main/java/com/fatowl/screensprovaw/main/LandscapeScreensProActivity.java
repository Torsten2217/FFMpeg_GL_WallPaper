...
public class LandscapeScreensProActivity extends ScreensProActivity implements
...
//		adview.loadAd(request);
		...
		if (numRun == 3) {
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
					LandscapeScreensProActivity.this);
							...
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									Intent ratingIntent = new Intent(
											...
											.parse("market://details?id=com.fatowl.screensprovaw"));
		...
		Log.v("TAG", "Resolution: " + width + "x" + height);
...
//		wallpaperFragment.isLoading = true;
		...
		menuIcon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				LandscapeScreensProActivity.this.openContextMenu(v);
			}
		});
