...
import com.fatowl.screensprovaw.glutils.GLText;
import com.fatowl.screensprovaw.service.*;

//Original code provided by Robert Green
//http://www.rbgrn.net/content/354-glsurfaceview-adapted-3d-live-wallpapers
public class VideoRenderer2 implements GLWallpaperService.Renderer {

	ScreensProService.CubeEngine _engine;

	public VideoRenderer2(ScreensProService.CubeEngine e) {
		_engine = e;
	}
