...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/Users/devsherif/Development/SDKs/AndroidSDK/android-ndk-r10d/platforms/android-3/arch-arm --soname-prefix=/data/data/com.fatowl.screensprovaw/lib/ --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-protocols --enable-protocol=file --enable-avfilter --disable-network --disable-avdevice --disable-asm --enable-shared --disable-symver --enable-small --disable-doc --optimization-flags=-O2 --prefix=../build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags=
...
SONAME_PREFIX=/data/data/com.fatowl.screensprovaw/lib/
SRC_PATH="/Users/devsherif/Desktop/FFvideoLiveWallpaper-master/jni/ffmpeg-android/ffmpeg"
SRC_PATH_BARE=/Users/devsherif/Desktop/FFvideoLiveWallpaper-master/jni/ffmpeg-android/ffmpeg
BUILD_ROOT="/Users/devsherif/Desktop/FFvideoLiveWallpaper-master/jni/ffmpeg-android/ffmpeg"
CC_IDENT=gcc 4.9 (prerelease)
ARCH=c
...
CPPFLAGS= --sysroot=/Users/devsherif/Development/SDKs/AndroidSDK/android-ndk-r10d/platforms/android-3/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -march=armv7-a -mfloat-abi=softfp  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O2 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -march=armv7-a -mfloat-abi=softfp  -fPIC -g
CC_O=-o $@
LDFLAGS=  --sysroot=/Users/devsherif/Development/SDKs/AndroidSDK/android-ndk-r10d/platforms/android-3/arch-arm -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
FFSERVERLDFLAGS=-Wl,-E
SHFLAGS=-shared -Wl,-soname,$$(SONAME_PREFIX)$$(@F) -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
YASMFLAGS=
BUILDSUF=
...
libavformat_VERSION=52.88.0
libavformat_VERSION_MAJOR=52
libavutil_VERSION=50.34.0
libavutil_VERSION_MAJOR=50
libavfilter_VERSION=1.69.0
