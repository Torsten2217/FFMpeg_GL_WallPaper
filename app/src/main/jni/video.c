...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_initVideo
...
/* pCodecCtx */
/* pFormatCtx */
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_loadVideo
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_prepareStorageFrame
(JNIEnv * env, jobject this)  {
...
jint Java_com_fatowl_screensprovaw_main_video_NativeCalls_getVideoWidth
(JNIEnv * env, jobject this)  {
  return pCodecCtx->width;
}

jint Java_com_fatowl_screensprovaw_main_video_NativeCalls_getVideoHeight
(JNIEnv * env, jobject this)  {
  return pCodecCtx->height;
}
 
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_getFrame
(JNIEnv * env, jobject this)  {
  ...
  while(av_read_frame(pFormatCtx, &packet)>=0) {
 	...
 	//if(img_convert_ctx == NULL)
	{
	  ...
	  img_convert_ctx = 
	   ...
	   __android_log_print(ANDROID_LOG_DEBUG, "NDK: ", "CTIcloseVideo>>>>2: [%d,%d)", w, h);
	  if(img_convert_ctx == NULL) {
	    /* __android_log_print(ANDROID_LOG_DEBUG,  */
	    /* 			"video.c",  */
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setLoopVideo
(JNIEnv * env, jobject this, jboolean b) {
  loopVideo = b;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_closeVideo
(JNIEnv * env, jobject this) {  
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_freeVideo
(JNIEnv * env, jobject this) {  
  if ( initializedVideo == 1 ) {
    /* // Free the YUV frame */
    av_free(pFrame); 
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_freeConversionStorage
(JNIEnv * env, jobject this) {  
  if ( initializedFrame == 1 ) {
    // Free the converted image
    av_free(bufferConverted); 
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_initPreOpenGL
(JNIEnv * env, jobject this)  { }

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_initOpenGL
(JNIEnv * env, jobject this)  {
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_updateVideoPosition
(JNIEnv * env, jobject this)  {
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_drawFrame
(JNIEnv * env, jobject this)  {
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_closeOpenGL
(JNIEnv *env, jobject this) {
  glDeleteTextures(1, &texturesConverted[len]); 
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_closePostOpenGL
(JNIEnv *env, jobject this) {
  //free(s_pixels);
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setScreenDimensions
(JNIEnv *env, jobject this, jint w, jint h) {
  screenWidth = w;
  screenHeight = h;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setTextureDimensions
...
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setWallVideoDimensions
(JNIEnv *env, jobject this, jint w, jint h) {
  wallVideoWidth = w;
  wallVideoHeight = h;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setWallDimensions
(JNIEnv *env, jobject this, jint w, jint h) {
  wallWidth = w;
  wallHeight = h;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setVideoMargins
(JNIEnv *env, jobject this, jint w, jint h) {
  marginX = w;
  marginY = h;
}
  
void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setOffsets
(JNIEnv *env, jobject this, jint x, jint y) {
  xOffSet = x;
  yOffSet = y;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setSteps
(JNIEnv *env, jobject this, jint xs, jint ys) {
  xStep = xs;
  yStep = ys;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setSpanVideo
(JNIEnv *env, jobject this, jboolean b) {
  spanVideo = b;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setDrawDimensions
(JNIEnv *env, jobject this, jint w, jint h) {
  drawWidth = w;
  drawHeight = h;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setScreenPadding
(JNIEnv *env, jobject this, jint w, jint h) {
  dPaddingX = w;
  dPaddingY = h;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setOrientation
(JNIEnv *env, jobject this, jboolean b) {
  isScreenPortrait = b;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_setPreviewMode
(JNIEnv *env, jobject this, jboolean b) {
  isPreview = b;
}

void Java_com_fatowl_screensprovaw_main_video_NativeCalls_toggleGetFrame
(JNIEnv *env, jobject this, jboolean b) {
  isGetFrame = b;
}
